...
///
/// Built on 2023-01-21 at 19:43 UTC
...
class StringsEn implements BaseTranslations<AppLocale, StringsEn> {
	...
	late final StringsErrorHandlerEn errorHandler = StringsErrorHandlerEn._(_root);
}
...
class StringsErrorHandlerEn {
	...
	late final StringsErrorHandlerCooldownEn cooldown = StringsErrorHandlerCooldownEn._(_root);
	late final StringsErrorHandlerUnauthorizedCommandEn unauthorizedCommand = StringsErrorHandlerUnauthorizedCommandEn._(_root);
	late final StringsErrorHandlerMissingArgumentsEn missingArguments = StringsErrorHandlerMissingArgumentsEn._(_root);
	late final StringsErrorHandlerInputParsingFailureEn inputParsingFailure = StringsErrorHandlerInputParsingFailureEn._(_root);
}
...
class StringsCommandsMusicEn {
	...
	late final StringsCommandsMusicChildrenEn children = StringsCommandsMusicChildrenEn._(_root);
}
...
class StringsCommandsRadioEn {
	...
	late final StringsCommandsRadioChildrenEn children = StringsCommandsRadioChildrenEn._(_root);
}
...
class StringsServicesMusicEn {
	...
	// Translations
	late final StringsServicesMusicTrackStuckEn trackStuck = StringsServicesMusicTrackStuckEn._(_root);
	late final StringsServicesMusicTrackStartedEn trackStarted = StringsServicesMusicTrackStartedEn._(_root);
	late final StringsServicesMusicTrackExceptionEn trackException = StringsServicesMusicTrackExceptionEn._(_root);
}
...
class StringsCommandsRadioChildrenEn {
	...
	// Translations
	late final StringsCommandsRadioChildrenPlayEn play = StringsCommandsRadioChildrenPlayEn._(_root);
	late final StringsCommandsRadioChildrenRecognizeEn recognize = StringsCommandsRadioChildrenRecognizeEn._(_root);
	late final StringsCommandsRadioChildrenRandomEn random = StringsCommandsRadioChildrenRandomEn._(_root);
}
...
class StringsCommandsRadioChildrenRecognizeEn {
	...
	late final StringsCommandsRadioChildrenRecognizeErrorsEn errors = StringsCommandsRadioChildrenRecognizeErrorsEn._(_root);
}

// Path: commands.radio.children.random
class StringsCommandsRadioChildrenRandomEn {
	StringsCommandsRadioChildrenRandomEn._(this._root);

	final StringsEn _root; // ignore: unused_field

	// Translations
	String get command => 'random';
	String get description => 'Selects a random radio station';
	String requestedBy({required Object mention}) => 'Requested by ${mention}';
	String get startedPlaying => 'Started playing';
	String startedPlayingDescription({required Object radio, required Object mention}) => 'Radio ${radio} started playing.\n\nRequested by ${mention}';
	late final StringsCommandsRadioChildrenRandomErrorsEn errors = StringsCommandsRadioChildrenRandomErrorsEn._(_root);
}
...
// Path: commands.radio.children.random.errors
class StringsCommandsRadioChildrenRandomErrorsEn {
	StringsCommandsRadioChildrenRandomErrorsEn._(this._root);

	final StringsEn _root; // ignore: unused_field

	// Translations
	String get title => 'An error occurred while finding a random radio';
	String get noResults => 'Couldn\'t find a radio to play :(';
}
...
class StringsEs extends StringsEn {
	...
	/// You can call this constructor and build your own translation instance of this locale.
	/// Constructing via the enum [AppLocale.build] is preferred.
	StringsEs.build({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver})
		: assert(overrides == null, 'Set "translation_overrides: true" in order to enable this feature.'),
		  $meta = TranslationMetadata(
		    locale: AppLocale.es,
		    overrides: overrides ?? {},
	...
	@override late final StringsEs _root = this; // ignore: unused_field

	// Translations
	@override late final StringsCommandsEs commands = StringsCommandsEs._(_root);
	@override late final StringsServicesEs services = StringsServicesEs._(_root);
	@override late final StringsErrorHandlerEs errorHandler = StringsErrorHandlerEs._(_root);
}

// Path: commands
class StringsCommandsEs extends StringsCommandsEn {
	StringsCommandsEs._(StringsEs root) : this._root = root, super._(root);
...
class StringsServicesEs extends StringsServicesEn {
	StringsServicesEs._(StringsEs root) : this._root = root, super._(root);

	@override final StringsEs _root; // ignore: unused_field

	// Translations
	@override late final StringsServicesMusicEs music = StringsServicesMusicEs._(_root);
}

// Path: errorHandler
class StringsErrorHandlerEs extends StringsErrorHandlerEn {
	StringsErrorHandlerEs._(StringsEs root) : this._root = root, super._(root);
	...
	@override late final StringsErrorHandlerCooldownEs cooldown = StringsErrorHandlerCooldownEs._(_root);
	@override late final StringsErrorHandlerUnauthorizedCommandEs unauthorizedCommand = StringsErrorHandlerUnauthorizedCommandEs._(_root);
	@override late final StringsErrorHandlerMissingArgumentsEs missingArguments = StringsErrorHandlerMissingArgumentsEs._(_root);
	@override late final StringsErrorHandlerInputParsingFailureEs inputParsingFailure = StringsErrorHandlerInputParsingFailureEs._(_root);
}

// Path: commands.info
class StringsCommandsInfoEs extends StringsCommandsInfoEn {
	StringsCommandsInfoEs._(StringsEs root) : this._root = root, super._(root);
	...
	@override String get addToServer => 'Añadir Radio Garden a mi servidor';
...
class StringsCommandsMusicEs extends StringsCommandsMusicEn {
	StringsCommandsMusicEs._(StringsEs root) : this._root = root, super._(root);
	...
	@override late final StringsCommandsMusicChildrenEs children = StringsCommandsMusicChildrenEs._(_root);
}

// Path: commands.radio
class StringsCommandsRadioEs extends StringsCommandsRadioEn {
	StringsCommandsRadioEs._(StringsEs root) : this._root = root, super._(root);
	...
	@override late final StringsCommandsRadioChildrenEs children = StringsCommandsRadioChildrenEs._(_root);
}

// Path: services.music
class StringsServicesMusicEs extends StringsServicesMusicEn {
	StringsServicesMusicEs._(StringsEs root) : this._root = root, super._(root);

	@override final StringsEs _root; // ignore: unused_field

	// Translations
	@override late final StringsServicesMusicTrackStuckEs trackStuck = StringsServicesMusicTrackStuckEs._(_root);
	@override late final StringsServicesMusicTrackStartedEs trackStarted = StringsServicesMusicTrackStartedEs._(_root);
	@override late final StringsServicesMusicTrackExceptionEs trackException = StringsServicesMusicTrackExceptionEs._(_root);
}

// Path: errorHandler.cooldown
class StringsErrorHandlerCooldownEs extends StringsErrorHandlerCooldownEn {
	StringsErrorHandlerCooldownEs._(StringsEs root) : this._root = root, super._(root);
...
// Path: errorHandler.unauthorizedCommand
class StringsErrorHandlerUnauthorizedCommandEs extends StringsErrorHandlerUnauthorizedCommandEn {
	StringsErrorHandlerUnauthorizedCommandEs._(StringsEs root) : this._root = root, super._(root);
...
// Path: errorHandler.missingArguments
class StringsErrorHandlerMissingArgumentsEs extends StringsErrorHandlerMissingArgumentsEn {
	StringsErrorHandlerMissingArgumentsEs._(StringsEs root) : this._root = root, super._(root);
...
// Path: errorHandler.inputParsingFailure
class StringsErrorHandlerInputParsingFailureEs extends StringsErrorHandlerInputParsingFailureEn {
	StringsErrorHandlerInputParsingFailureEs._(StringsEs root) : this._root = root, super._(root);
...
class StringsCommandsMusicChildrenEs extends StringsCommandsMusicChildrenEn {
	StringsCommandsMusicChildrenEs._(StringsEs root) : this._root = root, super._(root);
...
class StringsCommandsRadioChildrenEs extends StringsCommandsRadioChildrenEn {
	StringsCommandsRadioChildrenEs._(StringsEs root) : this._root = root, super._(root);

	@override final StringsEs _root; // ignore: unused_field

	// Translations
	@override late final StringsCommandsRadioChildrenPlayEs play = StringsCommandsRadioChildrenPlayEs._(_root);
	@override late final StringsCommandsRadioChildrenRecognizeEs recognize = StringsCommandsRadioChildrenRecognizeEs._(_root);
	@override late final StringsCommandsRadioChildrenRandomEs random = StringsCommandsRadioChildrenRandomEs._(_root);
}

// Path: services.music.trackStuck
class StringsServicesMusicTrackStuckEs extends StringsServicesMusicTrackStuckEn {
	StringsServicesMusicTrackStuckEs._(StringsEs root) : this._root = root, super._(root);
...
// Path: services.music.trackStarted
class StringsServicesMusicTrackStartedEs extends StringsServicesMusicTrackStartedEn {
	StringsServicesMusicTrackStartedEs._(StringsEs root) : this._root = root, super._(root);
...
// Path: services.music.trackException
class StringsServicesMusicTrackExceptionEs extends StringsServicesMusicTrackExceptionEn {
	StringsServicesMusicTrackExceptionEs._(StringsEs root) : this._root = root, super._(root);
...
// Path: commands.music.children.play
class StringsCommandsMusicChildrenPlayEs extends StringsCommandsMusicChildrenPlayEn {
	StringsCommandsMusicChildrenPlayEs._(StringsEs root) : this._root = root, super._(root);
...
// Path: commands.radio.children.play
class StringsCommandsRadioChildrenPlayEs extends StringsCommandsRadioChildrenPlayEn {
	StringsCommandsRadioChildrenPlayEs._(StringsEs root) : this._root = root, super._(root);
...
// Path: commands.radio.children.recognize
class StringsCommandsRadioChildrenRecognizeEs extends StringsCommandsRadioChildrenRecognizeEn {
	StringsCommandsRadioChildrenRecognizeEs._(StringsEs root) : this._root = root, super._(root);
	...
	@override String get artistField => 'Artista';
	@override String get genreField => 'Género';
	@override String get computationalTimeField => 'Tiempo de cálculo';
	@override late final StringsCommandsRadioChildrenRecognizeErrorsEs errors = StringsCommandsRadioChildrenRecognizeErrorsEs._(_root);
}

// Path: commands.radio.children.random
class StringsCommandsRadioChildrenRandomEs extends StringsCommandsRadioChildrenRandomEn {
	StringsCommandsRadioChildrenRandomEs._(StringsEs root) : this._root = root, super._(root);

	@override final StringsEs _root; // ignore: unused_field

	// Translations
	@override String get command => 'azar';
	@override String get description => 'Selecciona una radio al azar';
	@override String requestedBy({required Object mention}) => 'Pedido por ${mention}';
	@override String get startedPlaying => 'Se ha comenzado a reproducir';
	@override String startedPlayingDescription({required Object radio, required Object mention}) => 'La radio ${radio} ha comenzado a reproducirse.\n\nPedido por ${mention}';
	@override late final StringsCommandsRadioChildrenRandomErrorsEs errors = StringsCommandsRadioChildrenRandomErrorsEs._(_root);
}

// Path: commands.radio.children.recognize.errors
class StringsCommandsRadioChildrenRecognizeErrorsEs extends StringsCommandsRadioChildrenRecognizeErrorsEn {
	StringsCommandsRadioChildrenRecognizeErrorsEs._(StringsEs root) : this._root = root, super._(root);
...
// Path: commands.radio.children.random.errors
class StringsCommandsRadioChildrenRandomErrorsEs extends StringsCommandsRadioChildrenRandomErrorsEn {
	StringsCommandsRadioChildrenRandomErrorsEs._(StringsEs root) : this._root = root, super._(root);

	@override final StringsEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Hubo un error encontrando una radio al azar';
	@override String get noResults => 'No pude encontrar una radio al azar :(';
}
...
extension on StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'commands.info.addToServer': return 'Add Radio Garden to your server';
			...
			case 'commands.radio.children.recognize.artistField': return 'Artist';
			...
			case 'commands.radio.children.random.command': return 'random';
			case 'commands.radio.children.random.description': return 'Selects a random radio station';
			case 'commands.radio.children.random.requestedBy': return ({required Object mention}) => 'Requested by ${mention}';
			case 'commands.radio.children.random.startedPlaying': return 'Started playing';
			case 'commands.radio.children.random.startedPlayingDescription': return ({required Object radio, required Object mention}) => 'Radio ${radio} started playing.\n\nRequested by ${mention}';
			case 'commands.radio.children.random.errors.title': return 'An error occurred while finding a random radio';
			case 'commands.radio.children.random.errors.noResults': return 'Couldn\'t find a radio to play :(';
...
extension on StringsEs {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'commands.info.addToServer': return 'Añadir Radio Garden a mi servidor';
			...
			case 'commands.radio.children.recognize.artistField': return 'Artista';
			...
			case 'commands.radio.children.random.command': return 'azar';
			case 'commands.radio.children.random.description': return 'Selecciona una radio al azar';
			case 'commands.radio.children.random.requestedBy': return ({required Object mention}) => 'Pedido por ${mention}';
			case 'commands.radio.children.random.startedPlaying': return 'Se ha comenzado a reproducir';
			case 'commands.radio.children.random.startedPlayingDescription': return ({required Object radio, required Object mention}) => 'La radio ${radio} ha comenzado a reproducirse.\n\nPedido por ${mention}';
			case 'commands.radio.children.random.errors.title': return 'Hubo un error encontrando una radio al azar';
			case 'commands.radio.children.random.errors.noResults': return 'No pude encontrar una radio al azar :(';
